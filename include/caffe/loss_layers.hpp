...
/** Doering add 21.1
 * @brief Computes the classification accuracy for foreground and background of each segmentation channel
 */
template <typename Dtype>
class SegAccuracyMLLayer : public Layer<Dtype> {
 public:

  explicit SegAccuracyMLLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
 ...
 protected:
  ...
  std::vector<ConfusionMatrix*> confusion_matrices_;
